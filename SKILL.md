...
description: 面向客户质量经理与市场质量的客户满意度/NPS调查设计与分析技能；产出专业问卷与深度分析报告双版文档，区别于VOC痛点挖掘。
version: 1.0.0
---
...
4. **不便汇报**：纯文本难演示 → 双版输出（MD 归档、HTML 汇报）。
...
4. **先大纲后文档**：先呈现问卷+分析大纲，确认后生成双版；
5. **双版落盘**：调用 `scripts/build_report.py` 生成 `客户满意度调查_问卷.md`+`.html` 与 `客户满意度分析_报告.md`+`.html`；

> 为简化交付，脚本将"问卷"与"分析报告"合并输出为一套双版文档（含问卷卷首 + 分析主体）。
...
**输出**：
- `客户满意度调查.md`（问卷 + 分析报告，归档）
- `客户满意度调查.html`（汇报演示版，主色 #C8102E）
...
| Effectiveness 有效性 | 9 | 问卷+分析双版一体，HTML 可汇报；内置小样本可跑通 |
| **合计** | **43/50** | 过发布门槛（≥40） |
